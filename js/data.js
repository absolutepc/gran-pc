...
const DEFAULT_PRODUCTS = [
  ...
  { id: 'p2', name: 'Logitech G Pro X Superlight 2', category: 'peripherals', price: 14990, 
    ...
    description: 'Беспроводная игровая мышь, 60 г', stock: 25, wired: 'Беспроводной', 
    specs: { dpi: '32000', weight: '60 г' },
    fullDescription: 'Беспроводная игровая мышь, 60 г',
    colors: [
  ...
  { id: 'p3', name: 'AMD Ryzen 7 7800X3D', category: 'cpu', price: 26999, img: 'img/components/cpu/amd/R7 7800X3D.png', description: '8 ядер, 16 потоков, 3D V-Cache', badge: 'new', stock: 22, socket: 'AM5', memoryType: 'DDR5', specs: { cores: '8' } },
  { id: 'p4', name: 'Samsung 990 Pro 2TB NVMe', category: 'storage', price: 18990, img: 'img/categories/storage.svg', description: 'PCIe 4.0, чтение 7450 МБ/с', stock: 30, pcie: 'PCIe 4.0', specs: { capacity: '2 ТБ', type: 'NVMe' } },
  { id: 'p5', name: 'Corsair Vengeance 32GB DDR5', category: 'ram', price: 12990, img: 'img/categories/ram.svg', description: 'DDR5-6000 CL30, RGB', stock: 45, memoryType: 'DDR5', ram: '32 ГБ', specs: { capacity: '32 ГБ', speed: '6000 МГц' } },
  { id: 'p6', name: 'ASUS ROG Strix B650-E', category: 'motherboard', price: 28990, img: 'img/categories/motherboard.svg', description: 'AM5, PCIe 5.0, WiFi 6E', stock: 12, socket: 'AM5', memoryType: 'DDR5', specs: { formFactor: 'ATX' } },
  { id: 'p7', name: 'be quiet! Dark Power 13 850W', category: 'psu', price: 19990, img: 'img/categories/psu.svg', description: '80+ Titanium, полностью модульный', stock: 18, psutype: 'Полностью модульный', specs: { wattage: '850 Вт', efficiency: 'Titanium' } },
  { id: 'p8', name: 'NZXT Kraken X73 RGB', category: 'cooling', price: 15990, img: 'img/categories/cooling.svg', description: 'СЖО 360 мм, LCD-дисплей', stock: 10, liquid: '360 мм', specs: { type: 'AIO', size: '360 мм' } },
  {
...
const DEFAULT_READY_PCS = [
  ...
  {
    id: 'rpc2', name: 'Стрим Мастер', price: 149990, img: 'img/components/case/O11VP_014a.webp', badge: 'new',
  ...
  {
    id: 'rpc3', name: 'Бюджетный Воин', price: 89990, img: 'img/components/case/D400-B.png',
    ...
    colors: [
      { name: 'Чёрный', hex: '#1a1a1a', img: 'img/components/case/D400-B.png' },
      { name: 'Белый', hex: '#f0f0f0', img: 'img/components/case/D400-W.png' },
      { name: 'RGB', hex: '#8b5cf6', img: 'img/components/case/D41 MESH Black.png', filter: 'hue-rotate(45deg) saturate(1.35)' },
    ],
  ...
  {
    id: 'rpc4', name: 'Рабочая Станция Elite', price: 249990, img: 'img/components/case/O11VP_000a.webp',
  ...
  {
    id: 'rpc5', name: 'Компактный Mini', price: 119990, img: 'img/components/case/mod-3-black.png',
  ...
  {
    id: 'rpc6', name: 'Киберспортивный Чемпион', price: 129990, img: 'img/components/case/D41 MESH Black.png', badge: 'new',
